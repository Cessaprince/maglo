...
const Settings2 = () => {
    return (
        <div>
                        ...
                        <form action="" className='flex flex-col gap-5 w-full'>
                            <div className="flex gap-5 items-center">
                                <div className="flex flex-col gap-1 w-[50%]">
                                    ...
                                    <input type="text" name="" id="" className='py-2 px-5 border-gray-300 border-[0.1px] rounded-[5px]' placeholder='Oluchi' />
                                </div>
                                <div className="flex flex-col gap-1 flex-1">
                                    <label htmlFor="" className='capitalize text-sm font-semibold'>last name</label>
                                    <input type="text" name="" id="" className='py-2 px-5 border-gray-300 border-[0.1px] rounded-[5px]' placeholder='Nabil' />
                                </div>
                            </div>
                            ...
                            <div className="flex gap-5 items-center">
                                <div className="flex flex-col gap-1 w-[50%]">
                                    ...
                                    <input type="date" name="" id="" className='py-2 px-5 border-gray-300 border-[0.1px] rounded-[5px]' placeholder='DD / MM / YYYY' />
                                </div>
                                <div className="flex flex-col gap-1 flex-1">
                                    <label htmlFor="" className='capitalize text-sm font-semibold'>mobile number</label>
                                    <input type="number" name="" id="" className='p-2 border-gray-300 border-[0.1px] rounded-[5px]' placeholder='09023899735' />
                                </div>
                            </div>
                            ...
                            <div className="flex gap-5 items-center">
                                <div className="flex flex-col gap-1 w-full">
                                    ...
                                    <input type="email" name="" id="" className='py-2 px-5 border-gray-300 border-[0.1px] rounded-[5px]' placeholder='cessaprince125@gmail.com' />
                                </div>
                            </div>
                            ...
                            <div className="flex gap-5 items-center">
                                <div className="flex flex-col gap-1 w-[50%]">
                                    ...
                                    <input type="password" name="" id="" className='py-2 px-5 border-gray-300 border-[0.1px] rounded-[5px]' placeholder='••••••••' />
                                </div>
                                <div className="flex flex-col gap-1 flex-1">
            ...
            <button type="submit" className='ml-10 mt-5 py-3 px-15 border-[0.1px] border-gray-200 rounded-[5px] bg-green-600 text-white hover:bg-green-400 hover:cursor-pointer'>Update</button>
        </div>
    )
}
